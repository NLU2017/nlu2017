...
class BasicSeq2Seq(Seq2SeqModel):
  ...
  def __init__(self, params, mode, name="basic_seq2seq"):
    ...
    print("params encoder {}".format(self.params['encoder.class']))
    print("encoder class {}".format(self.encoder_class))
