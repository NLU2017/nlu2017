...
python3 ./split_triplets.py --type=reverse $TRAIN_INPUT

echo "split triplets in validation data"
python3 ./split_triplets.py --type=reverse $VALIDATION_INPUT
...
#
python3 $SEQ2SEQ_TOOLS/generate_vocab.py --max_vocab_size $MAX_VOCAB_SIZE --min_frequency $MIN_FREQUENCY $DATA_PATH/Training_Shuffled_Dataset_source.txt > $VOCABULARY
