...
DATA_PATH=./data
OUTPUT_DIR=$DATA_PATH/double_src
...
python3 ./split_triplets_for_double_source.py --output_dir=$OUTPUT_DIR $TRAIN_INPUT

echo "split triplets in validation data"
python3 ./split_triplets_for_double_source.py --output_dir=$OUTPUT_DIR $VALIDATION_INPUT


#generate the vocabulary from the source file (contains the same data in terms of words as the target file...)
